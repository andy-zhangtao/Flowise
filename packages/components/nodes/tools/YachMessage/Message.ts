...
class YachMessage_Tools implements INode {
    label: string
    name: string
    version: number
    description: string
    ...
    constructor() {
        this.label = 'YachMessage'
        this.name = 'yachMessage'
        this.version = 1.0
        this.type = 'YachMessage'
        this.icon = 'requestspost.svg'
        this.category = 'Tools'
        this.description = 'Execute HTTP POST requests for yach message'
...
module.exports = { nodeClass: YachMessage_Tools }
