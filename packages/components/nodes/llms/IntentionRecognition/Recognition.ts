...
class Recognition_LLMs implements INode {
    label: string
    name: string
    version: number
    type: string
    ...
    constructor() {
        this.label = 'Recognition'
        this.name = 'recognition'
        this.version = 3.0
        this.type = 'Recognition'
        this.icon = 'recognition.png'
        this.category = 'LLMs'
        this.description = 'Use for recognition'
...
module.exports = { nodeClass: Recognition_LLMs }
